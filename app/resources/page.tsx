...
const Resources: React.FC = () => {
  return (
    <main className="resources-page">
      ...
      <section className="resource-centre-header container mx-auto text-center py-24 bg-[rgba(0,0,0,0.5)] text-white mb-10">
      ...
      {/* Resources Section */}
      <section className="resources-section  bg-[rgba(0,0,0,0.5)] py-12 mb-10">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="resource-card bg-white p-4 rounded-lg shadow-lg text-black mb-6">
