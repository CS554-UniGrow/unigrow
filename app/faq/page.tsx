...
const FaqItem: React.FC<FaqItemProps> = ({ question, answer, children }) => {
  ...
  return (
    <div className="faq-question py-4">
      <h3
        className="mb-4 cursor-pointer text-2xl font-semibold"
        onClick={toggleOpen}
      >
        {question}
      </h3>
...
export default function Faq() {
  return (
    <main className="faq-page">
      {/* FAQ Header */}
      <section className="faq-header-section container mx-auto bg-[rgba(0,0,0,0.5)] py-24 text-center text-white">
      ...
      <section className="faq-questions-section py-12">
        <div className="container mx-auto divide-y divide-gray-300">
          ...
          <FaqItem question="How can I obtain my Canvas key?">
            <p>
              Getting your Canvas key is simple. Watch our step-by-step guide on
              YouTube for detailed instructions.
            </p>
